...
export const mockData = {
  ...
  citizens: [
    { id: '1', name: 'João Silva Santos', email: 'joao.silva@email.com', phone: '(11) 99999-9999', cpf: '123.456.789-00', city: 'São Paulo', state: 'SP', neighborhood: 'Centro', tags: ['demandante frequente'], status: 'client' as const, score: 850, createdAt: '2026-01-15', updatedAt: '2026-04-20' },
    { id: '2', name: 'Maria Oliveira Costa', email: 'maria.oliveira@email.com', phone: '(21) 98888-8888', cpf: '987.654.321-00', city: 'Rio de Janeiro', state: 'RJ', neighborhood: 'Jardim América', tags: ['líder comunitária'], status: 'prospect' as const, score: 620, createdAt: '2026-02-01', updatedAt: '2026-04-18' },
    { id: '3', name: 'Pedro Henrique Santos', email: 'pedro.santos@email.com', phone: '(31) 97777-7777', cpf: '456.789.123-00', city: 'Belo Horizonte', state: 'MG', neighborhood: 'Vila Nova', tags: ['comerciante'], status: 'client' as const, score: 450, createdAt: '2026-01-20', updatedAt: '2026-04-15' },
    { id: '4', name: 'Ana Paula Ferreira', email: 'ana.ferreira@email.com', phone: '(41) 96666-6666', cpf: '321.654.987-00', city: 'Curitiba', state: 'PR', neighborhood: 'Santo Antônio', tags: ['estudante'], status: 'lead' as const, score: 120, createdAt: '2026-03-10', updatedAt: '2026-04-10' },
    { id: '5', name: 'Carlos Eduardo Lima', email: 'carlos.lima@email.com', phone: '(51) 95555-5555', cpf: '654.321.987-00', city: 'Porto Alegre', state: 'RS', neighborhood: 'Bela Vista', tags: ['aposentado'], status: 'client' as const, score: 380, createdAt: '2026-02-28', updatedAt: '2026-04-08' },
    { id: '6', name: 'Juliana Aparecida', email: 'juliana@email.com', phone: '(61) 94444-4444', cpf: '789.123.456-00', city: 'Brasília', state: 'DF', neighborhood: 'Centro', tags: ['professora'], status: 'prospect' as const, score: 210, createdAt: '2026-03-05', updatedAt: '2026-04-05' },
  ] as Citizen[],
